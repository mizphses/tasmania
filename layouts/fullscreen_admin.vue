<template>
  <div>
    <Navbar :authed="false" class="fixed x-0 y-0 z-30" />
    <div v-if="role == 'admin'">
      <div
        class="w-full py-2 px-5 flex flex-row justify-between items-center shadow-lg bg-red-900 text-white font-bold mb-2 fixed top-20 z-0"
      >
